...
export const organizationSchema = {
  ...
  description:
    "AI-powered Vedic astrology platform generating detailed, personalized Janam Kundli birth chart reports.",
  foundingDate: "2026",
  areaServed: "IN",
  knowsAbout: [
    "Vedic astrology",
...
export const websiteSchema = {
  ...
  url: BASE_URL,
  description:
    "Get your personalized Vedic astrology report in 60 seconds, from ₹299, based on your exact birth chart.",
...
export const productSchema = {
  ...
  description:
    "AI-powered, personalized Vedic astrology birth chart report based on your exact date, time, and place of birth. Available in Essential (₹299), Premium (₹499) and Master (₹999) tiers.",
  ...
  offers: {
    ...
    shippingDetails: {
      ...
      deliveryTime: { "@type": "ShippingDeliveryTime", handlingTime: { "@type": "QuantitativeValue", minValue: 0, maxValue: 0, unitCode: "MIN" }, transitTime: { "@type": "QuantitativeValue", minValue: 0, maxValue: 1, unitCode: "MIN" } },
    },
  ...
  review: {
    ...
    reviewBody: "Incredibly detailed and accurate report. The planetary positions matched my known chart perfectly.",
  },
};
