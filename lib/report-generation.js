...
import { luckyFactorsForAscendant } from "./lucky-factors.js";
...
export async function generateFullReport({
  ...
  const luckyFactors = luckyFactorsForAscendant(signIdx);
...
MANGLIK INSTRUCTION: Wherever you discuss Manglik status, you MUST use the verdict and reasoning stated above. Do NOT decide it yourself — Manglik houses are only 1, 2, 4, 7, 8, and 12 (never the 9th). If the status says "SECONDARY (Venus-based) ONLY", you MUST present it as a SECONDARY, less-severe condition — clearly state the person is NOT traditional Manglik (they are clear from both the Ascendant and the Moon), and NEVER write a flat "you are Manglik and should be cautious." Do not alarm the reader or demand strict Manglik matching or major remedies for a secondary-only case.
