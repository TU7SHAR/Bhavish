        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-invert max-w-none space-y-6 text-muted leading-relaxed">
            ...
            <section>
              ...
              <p className="font-medium text-accent">IMPORTANT: BhavishAI reports are generated using high-precision astronomical calculations combined with classical Vedic astrology principles.</p>
