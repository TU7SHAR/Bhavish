        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8">
            {reportData.sections.map((section, i) => {
              ...
              // Insert login CTA after section 3 (between 4th and 5th section) — only if not logged in
              if (i === 3 && !user) {
                return (
                  <div key={`section-group-${i}`}>
                    ...
                    <div className="bg-gradient-to-br from-primary/15 via-purple-500/10 to-transparent border border-primary/30 rounded-2xl p-6 md:p-8 text-center">
                      <div className="max-w-md mx-auto">
                        ...
                        <h3 className="text-lg md:text-xl font-bold text-foreground mb-2">Save Your Report Forever</h3>
                        <p className="text-muted text-sm leading-relaxed mb-5">
                          Sign in with Google to save this report to your account. Access it anywhere, anytime — from any device. Your report stays safe in your personal dashboard.
                        </p>
                        <button
                        ...
                        <p className="text-muted/60 text-xs mt-3">Free • Takes 2 seconds • No spam</p>
                      </div>
                    </div>
                  </div>
                );
