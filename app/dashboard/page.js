              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted text-sm mt-1">You have <strong className="text-foreground">5 free reports every month</strong> for 2 years. Generate reports for yourself, family, or friends — no charge.</p>
                  </div>
                </div>
                <Link
                  href="/founder/new"
