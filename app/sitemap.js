...
export default async function sitemap() {
  ...
  const staticRoutes = [
    ...
    { url: `${baseUrl}/tools/rashi-calculator`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
    { url: `${baseUrl}/tools/nakshatra-calculator`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
    { url: `${baseUrl}/tools/kaal-sarp-calculator`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
    { url: `${baseUrl}/tools/dasha-calculator`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
    { url: `${baseUrl}/tools/lucky-factors`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
