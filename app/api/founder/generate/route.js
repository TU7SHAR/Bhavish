...
MANGLIK INSTRUCTION: In Section 14 you MUST use the Manglik verdict and reasoning stated above. Do NOT decide Manglik status yourself or invent which house triggers it — Manglik houses are only 1, 2, 4, 7, 8, and 12 (never the 9th). If the status says "SECONDARY (Venus-based) ONLY", present it as a SECONDARY, less-severe condition, clearly state the person is NOT traditional Manglik (clear from Ascendant and Moon), and never write a flat "you are Manglik and should be cautious."
